...
class MechanicUpdatePartsScreen extends StatelessWidget {
  const MechanicUpdatePartsScreen({super.key});
                            ...
                            SizedBox(
                              ...
                              child: CustomButton(
                                ...
                                onPressed: () {
                                  ...
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => MechanicUpdatePartsConfirmScreen(details: _filteredMedicineList[index],),));
